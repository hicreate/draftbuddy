<template>
  <v-row>
    <v-col lg="4" v-for="(pos, index) in best" :key="index">
        ...
        <v-list-item three-line>
          <v-list-item-content>
            ...
            <v-list-item-subtitle>
              Proj. Pts:
              {{ pos.players[0].FantasyPoints }}
            </v-list-item-subtitle>
            <v-list-item-subtitle>
              Pos. Rank:
              {{ pos.players[0].PositionRank }}
            </v-list-item-subtitle>
          </v-list-item-content>

          <v-list-item-avatar size="74px" class="d-flex flex-column blue-grey darken-3 pa-1">
            <h6>ADP</h6>
            <h2
              :class="adpColor(pos.players[0].AverageDraftPosition)"
            >{{ pos.players[0].AverageDraftPosition }}</h2>
          </v-list-item-avatar>
        </v-list-item>
      </v-card>
    </v-col>
